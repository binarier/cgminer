...
#define USB_PARSE_COMMANDS(USB_ADD_COMMAND) \
	...
	USB_ADD_COMMAND(C_CLAM_VERSION, "CMVersion") \
	USB_ADD_COMMAND(C_CLAM_CHANNELS, "CMChannels") \
	USB_ADD_COMMAND(C_CLAM_CORES, "CMCores") \
	USB_ADD_COMMAND(C_CLAM_RESET_CONTROLLER, "CMResetController") \
	USB_ADD_COMMAND(C_CLAM_RESET_CHANNEL, "CMResetChannel") \
	USB_ADD_COMMAND(C_CLAM_FLUSH_WORK, "CMFlushWork") \
	USB_ADD_COMMAND(C_CLAM_WORK_QUEUE, "CMWorkQueue") \
	USB_ADD_COMMAND(C_CLAM_FLUSH_RESULT, "CMFlushResult") \
	USB_ADD_COMMAND(C_CLAM_CLOCK, "CMClock") \
	USB_ADD_COMMAND(C_CLAM_WRITE_WORK, "CMWriteWork") \
	USB_ADD_COMMAND(C_CLAM_FLUSH_BUFFER, "CMFlushBuffer") \
	USB_ADD_COMMAND(C_CLAM_READ_DATA, "CMReadData") \
