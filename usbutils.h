...
#define USB_PARSE_COMMANDS \
	...
	USB_ADD_COMMAND(C_CLAM_READ_REGISTER, "CMReadRegister") \
	USB_ADD_COMMAND(C_CLAM_WRITE_REGISTER, "CMWriteRegister") \
	USB_ADD_COMMAND(C_CLAM_SET_TIMEOUT, "CMSetTimeout") \
	...
	USB_ADD_COMMAND(C_CLAM_CHANNEL_ENABLE, "CMChannelEnable") \
