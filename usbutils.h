...
#define USB_PARSE_COMMANDS \
	...
	USB_ADD_COMMAND(C_CLAM_FTDI_RESET, "CMFtdiReset") \
	USB_ADD_COMMAND(C_CLAM_SET_RTS, "CMSetRTS") \
	USB_ADD_COMMAND(C_CLAM_SET_DTR, "CMSetDTR") \
	USB_ADD_COMMAND(C_CLAM_CLEAR_RTS, "CMClearRTS") \
	USB_ADD_COMMAND(C_CLAM_CLEAR_DTR, "CMClearDTR") \
